...
//    }
    ...
    public void userNavigatesToTheMachinesPage() {
        nespressoHomePage.goToMachinesPage();
    }

    //    @When("User adds Machine (.+) to the cart with a valid quantity (.+)")
//    public void user_adds_machine_to_the_cart_with_valid_quantity(String productName, String quantity) {
//    }
    @When("^User adds Machine (.+) to the cart with a valid quantity (.+)$")
    public void user_adds_machine_inissia_to_the_cart_with_a_valid_quantity(String productname, String quantity) throws Throwable {
        nespressoMachinesPage.addMachineToCartWithValidQuantity(productname, quantity);
        // Write code here that turns the phrase above into concrete actions
    }
